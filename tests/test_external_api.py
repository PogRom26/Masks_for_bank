...
@pytest.mark.skipif(not os.getenv('API_KEY'), reason="Требуется API ключ")
def test_real_api_connection():
    """Интеграционный тест с реальным API (выполняется только при наличии API_KEY)"""
    result = get_currency_rate("USD", "EUR", 1)
