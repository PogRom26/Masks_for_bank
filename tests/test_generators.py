...
def test_filter_by_currency(data_for_tests):
    ...
    assert list(filter_by_currency(data_for_tests)) == [{'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572', 'operationAmount': {'amount': '9824.07', 'currency': {'name': 'USD', 'code': 'USD'}}, 'description': 'Перевод организации', 'from': 'Счет 75106830613657916952', 'to': 'Счет 11776614605963066702'},
...
def test_transaction_descriptions(data_for_tests):
    """Тест функции фильтра по виду операции по конкретному файлу"""
